...
<body>
  <div class="text-center">
    ...
    <hr><br>
    <h3 style="font-weight: 700; margin-top: 20px;"><u>SURAT KELUAR</u></h3>
  <h4 style="font-weight: 400; margin-top: 20px;">Nomor : 000{{ $data->id_keluar }}/keluar/<?php echo date("d/m/Y") ?></h4><br><br>
  </div>
    <table style="margin-left: 50px; margin-top:40px;">
      <tr style="padding-top: -20px;  height:300px; min-height:300px;">
        <td colspan="3">
          <h6>A. Data Penduduk Keluar</h6>
        </td>
      </tr>
