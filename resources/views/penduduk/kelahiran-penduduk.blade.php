...
<div class="row">
  <div class="col-md-12">
    <h1>Lapor Kelahiran</h1>
    <h5>Form Pelaporan Kelahiran Penduduk Baru</h5>
  ...
  <div class="col-md-12 mt-3 card p-2 p-4">
    ...
    <div class="tab-content mt-3" id="custom-content-above-tabContent">
      ...
      <div class="tab-pane fade show active" id="custom-content-above-home" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
        <form method="POST" action="{{ url('/penduduk/kelahiran-penduduk/penduduk-tetap') }}">
          @csrf
          <div class="row p-2">
            <div class="col-md-12 text-primary pt-2" style="border-radius: 10px">
              <h4>A. Data Penduduk</h4>
            </div>
          </div>
          ...
          <div class="form-group row">
            <div class="col-md-12">
              ...
              <input id="nik" type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" value="Belum Ada, Segera Melapor Pengurus RW Untuk Mengurus Akte Kelahiran-{{ date("Ymd") }}-{{rand(100,999)}}" required autocomplete="nik" autofocus readonly>
          ...
          <div class="form-group row">
            <div class="col-md-12">
              ...
              <textarea id="alasan" type="textarea" class="form-control @error('alasan') is-invalid @enderror" name="alasan" value="{{ old('alasan') }}" required autocomplete="alasan" height="400" autofocus>Ikut Orang Tua Menjadi Warga RT.003 RW.03</textarea>
          ...
          <div class="row p-2">
            <div class="col-md-12 text-primary pt-2" style="border-radius: 10px">
              <h4>B. Data Laporan Kelahiran</h4>
            </div>
          </div>
          ...
          <div class="form-group row">
            <div class="col-md-12">
              <label for="tempat_lahir" class="col-form-label mb-0 pl-0 pb-0">Tempat Lahir (Rumah Sakit / Tempat Persalinan Lainnya)</label>
              <input id="tempat_lahir" type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" name="tempat_lahir" value="{{ old('tempat_lahir') }}" required autocomplete="tempat_lahir" autofocus>
          ...
          <div class="form-group row">
            <div class="col-md-12">
              <label for="kota_lahir" class="col-form-label mb-0 pl-0 pb-0">Kota Lahir</label>
      ...
      <div class="tab-pane fade" id="custom-content-above-profile" role="tabpanel" aria-labelledby="custom-content-above-profile-tab">
          <form method="POST" action="{{ url('/penduduk/kelahiran-penduduk/penduduk-sementara') }}">
          @csrf
          <div class="row p-2">
            <div class="col-md-12 text-primary pt-2" style="border-radius: 10px">
              <h4>A. Data Penduduk</h4>
          ...
          <div class="form-group row">
            <div class="col-md-6">
              ...
              <input id="no_kk" type="text" class="form-control @error('no_kk') is-invalid @enderror" name="no_kk" value="Belum Ada, Segera Melapor Pengurus RW Untuk Mengurus Akte Kelahiran" required autocomplete="no_kk" autofocus readonly>
