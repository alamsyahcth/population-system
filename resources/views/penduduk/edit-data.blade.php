...
<div class="row">
  <div class="col-md-12">
    ...
    @if($status != 0)
      <div class="alert alert-danger" role="alert">
        <strong>Maaf, kamu belum bisa mengubah data karena perubahan data terakhir kamu belum kamu laporkan, segera laporkan kepada pengurus RT</strong>
      </div>
    @endif
  </div>
  <div class="col-md-12 col-sm-12 mt-4">
    <div class="card p-3">
      <div class="card-body">
        <form method="POST" action="{{ url('/penduduk/edit-data/store') }}">
          @csrf
          <div class="form-group row">
            {{-- <div class="col-md-12">
              <label for="keluarga" class="col-form-label mb-0 pl-0 pb-2">Pilih Keluarga</label>
              <select id="keluarga" class="form-control select2 @error('keluarga') is-invalid @enderror" name="keluarga" required @if($status != 0) readonly @endif autocomplete="keluarga" autofocus>
          ...
          <div class="form-group row">
            <div class="col-md-12">
              ...
              <input id="nik" type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" value="{{ $data->nik }}" required @if($status != 0) readonly @endif autocomplete="nik" autofocus>
          ...
          <div class="form-group row">
            <div class="col-md-12">
              ...
              <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $data->name }}" required @if($status != 0) readonly @endif autocomplete="name" autofocus>
          ...
          <div class="form-group row">
            <div class="col-md-3">
              ...
              <select id="jenis_kelamin" class="form-control @error('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin" value="{{ $data->jenis_kelamin }}" required @if($status != 0) disabled @endif autocomplete="jenis_kelamin" autofocus>
            ...
            <div class="col-md-3">
              ...
              <select id="agama" class="form-control @error('agama') is-invalid @enderror" name="agama" value="{{ $data->agama }}" required @if($status != 0) disabled @endif autocomplete="agama" autofocus>
            ...
            <div class="col-md-3">
              ...
              <input id="tempat_lahir" type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" name="tempat_lahir" value="{{ $data->tempat_lahir }}" required @if($status != 0) readonly @endif autocomplete="tempat_lahir" autofocus>
            ...
            <div class="col-md-3">
              ...
              <input id="tanggal_lahir" type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" name="tanggal_lahir" value="{{ $data->tanggal_lahir }}" required @if($status != 0) readonly @endif autocomplete="tanggal_lahir" autofocus>
          ...
          <div class="form-group row">
            <div class="col-md-3">
              ...
              <select id="pendidikan" class="form-control @error('pendidikan') is-invalid @enderror" name="pendidikan" value="{{ $data->pendidikan }}" required @if($status != 0) disabled @endif autocomplete="pendidikan" autofocus>
            ...
            <div class="col-md-3">
              ...
              <input id="pekerjaan" type="text" class="form-control @error('pekerjaan') is-invalid @enderror" name="pekerjaan" value="{{ $data->pekerjaan }}" required @if($status != 0) readonly @endif autocomplete="pekerjaan" autofocus>
            ...
            <div class="col-md-3">
              ...
              <select id="status_perkawinan" class="form-control @error('status_perkawinan') is-invalid @enderror" name="status_perkawinan" value="{{ $data->status_perkawinan }}" required @if($status != 0) disabled @endif autocomplete="status_perkawinan" autofocus>
            ...
            <div class="col-md-3">
                ...
                <select id="status_dalam_keluarga" class="form-control @error('status_dalam_keluarga') is-invalid @enderror" name="status_dalam_keluarga" value="{{ $data->status_dalam_keluarga }}" required @if($status != 0) disabled @endif autocomplete="status_dalam_keluarga" autofocus>
          ...
          <div class="form-group row">
            <div class="col-md-6">
                ...
                <input id="nama_ayah" type="text" class="form-control @error('nama_ayah') is-invalid @enderror" name="nama_ayah" value="{{ $data->nama_ayah }}" required @if($status != 0) readonly @endif autocomplete="nama_ayah" autofocus>
            ...
            <div class="col-md-6">
              ...
              <input id="nama_ibu" type="text" class="form-control @error('nama_ibu') is-invalid @enderror" name="nama_ibu" value="{{ $data->nama_ibu }}" required @if($status != 0) readonly @endif autocomplete="nama_ibu" autofocus>
          ...
          <div class="form-group row">
              <div class="col-md-12">
                  ...
                  <select id="kewarganegaraan" class="form-control @error('kewarganegaraan') is-invalid @enderror" name="kewarganegaraan" value="{{ $data->kewarganegaraan }}" required @if($status != 0) disabled @endif autocomplete="kewarganegaraan" autofocus>
          ...
          <div class="form-group row">
            <div class="col-md-12">
              ...
              <textarea id="alamat" type="textarea" class="form-control @error('alamat') is-invalid @enderror" name="alamat" value="{{ $data->alamat }}" required @if($status != 0) readonly @endif autocomplete="alamat" height="400" autofocus>{{ $data->alamat }}</textarea>
